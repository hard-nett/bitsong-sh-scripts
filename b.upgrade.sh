KEY1=$(jq -r '.name' ./test-keys/relayer_seed.json)
ADDR1=$(jq -r '.address' ./test-keys/relayer_seed.json)
KEY2=$(jq -r '.name' ./test-keys/validator_seed.json)
ADDR2=$(jq -r '.address' ./test-keys/validator_seed.json)
